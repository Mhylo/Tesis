...
Expected: PASS, 12 pruebas (los `parametrize` cuentan por separado).
...
Expected: PASS, 21 pruebas. `test_importar_roi_no_arrastra_matplotlib` pasa ahora de verde después de haberlo visto rojo en el Step 3: eso es lo que hace que el guardián valga algo. Copia esta salida al informe como evidencia GREEN.
